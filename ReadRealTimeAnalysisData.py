...
class ImportOffline():
    ...
    def __init__(self):
        ...
        output_file = open("C:\\J.Lee\OES_Output.csv", "w")
        ...
        response = requests.put(url + '/Things/OESThing/Properties/*', headers=header, json=main, verify=False)
